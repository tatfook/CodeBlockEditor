...
Blockly.ScratchBlocks.ProcedureUtils.createAllInputs_ = function(connectionMap) {
  ...
  var btn_input = this.appendValueInput("image_btn");
  var btn_field = new Blockly.FieldButton({
      src: "png/plus-2x.png",
  }, 0, 0, 16, 16, false, "FIELD_BUTTON_CALLBACK_append_attr2");
  btn_input.appendField(btn_field);
...
Blockly.ScratchBlocks.ProcedureUtils.removeFieldCallback_mcml_attr = function (field) {
...
Blockly.Blocks['procedures_declaration'] = {
  ...
  removeFieldCallback: Blockly.ScratchBlocks.ProcedureUtils.removeFieldCallback_mcml_attr,
